...
const STYLES = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 768px) {
    ...
    .right { display: none; position: fixed; inset: 0; z-index: 100; background: var(--surface2); }
    .right.open { display: flex; flex-direction: column; }
  }
          ...
          <div className="hdr">
            <div className="hdr-top">
              ...
              <div style={{textAlign:"right"}}>
                ...
                <div style={{fontFamily:"Barlow Condensed",fontSize:10,color:"var(--border)",letterSpacing:1,textAlign:"right",marginTop:2}}>v{APP_VERSION}</div>
              </div>
            </div>
            {updateAvailable && (
