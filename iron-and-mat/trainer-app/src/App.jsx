...
const STYLES = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 768px) {
    .shell { display: block; position: relative; overflow: hidden; height: 100vh; }
    .left { width: 100%; min-width: 0; height: 100vh; position: absolute; top: 0; left: 0; right: 0; bottom: 0; transition: transform 0.3s ease; }
    .left.hidden { transform: translateX(-100%); pointer-events: none; }
    .right { display: flex !important; flex-direction: column; position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: var(--bg); z-index: 50; transition: transform 0.3s ease; transform: translateX(100%); }
...
export default function App() {
  ...
  return (
    <>
      ...
      <div className="shell">
        {/* ── LEFT ── */}
        <div className={`left ${isRightOpen ? "hidden" : ""}`}>
          <div className="hdr">
            <div className="hdr-top">
              ...
              <div style={{textAlign:"right"}}>
                ...
                <div style={{fontFamily:"Barlow Condensed",fontSize:10,color:"var(--muted)",letterSpacing:1,textAlign:"right",marginTop:2}}>v{APP_VERSION}</div>
              </div>
            </div>
            {updateAvailable && (
          ...
          <div style={{position:"absolute",bottom:0,left:0,right:0,textAlign:"center",paddingBottom:3,pointerEvents:"none",zIndex:9}}>
            <span style={{fontFamily:"Barlow Condensed",fontSize:9,color:"var(--muted)",letterSpacing:1}}>v{APP_VERSION}</span>
          </div>
        </div>
